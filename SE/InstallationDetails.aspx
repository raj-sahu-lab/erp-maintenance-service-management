<%@ page title=" Installation | Installation Details " language="C#" masterpagefile="~/SE/AdminPage.master" autoeventwireup="true" inherits="InstallationDetails, App_Web_qupml30j" %>
    ...
    <fieldset id="fldStream" style="border: 1px solid #006600; width: 95.5%; margin: 16px;">
        ...
        <div>
            <table style="border-bottom-style: dashed; border-bottom-width: 1px; border-top-style: dashed;
                ...
                <tr>
                    <td class="TopLMsg">
                        Filter By&nbsp; [Invoice No , Serial No]
                    </td>
                    <td class="TopRMsg">
                                            ...
                                            <ContentTemplate>
                                                <asp:GridView ID="grdvwInstallation" runat="server" CssClass="mGrid" AutoGenerateColumns=" False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="CDName" HeaderText="Hospitals" ItemStyle-Width="250px" ItemStyle-HorizontalAlign="Left" />
                                                        ...
                                                        <asp:BoundField DataField="ServiceFrom" HeaderText="Install Date" ItemStyle-Width="70px" ItemStyle-HorizontalAlign="Center" />
                                                ...
                                                <asp:SqlDataSource ID="sDsvwInstallation" runat="server" ConnectionString="<%$ ConnectionStrings:ConnStr %>"
                                                    SelectCommand="SELECT ROW_NUMBER() OVER(ORDER BY InsID) AS Row , [InvoiceNo] As Code ,  [InvoiceNo] , MacName, [SerialNo] , [CDName] ,convert(varchar, [ServiceFrom], 103) as ServiceFrom From vwInstallation Where EmpID =@EmpID Order by Code"
                                                    FilterExpression=" InvoiceNo like '%{0}%' or SerialNo like '%{1}%' ">
                                                    <FilterParameters>
