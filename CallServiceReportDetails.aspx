<%@ page title="Call Type | Call Type Details" language="C#" masterpagefile="~/AdminPage.master" autoeventwireup="true" inherits="CallServiceReportDetails, App_Web_tjb0csgq" %>
    ...
    <fieldset id="fldStream" style="border: 1px solid #006600; width: 95.5%; margin: 16px;">
        ...
        <div>
            <table style="border-bottom-style: dashed; border-bottom-width: 1px; border-top-style: dashed;
                ...
                <tr>
                    <td class="TopLMsg">
                        Filter By&nbsp; [Hospital , Equipment & Serial No.]
                    </td>
                    <td class="TopRMsg">
                                        ...
                                        <asp:UpdatePanel ID="udpvwCallServiceReport" runat="server">
                                            <ContentTemplate>
                                                ...
                                                <asp:SqlDataSource ID="sDsvwCallServiceReport" runat="server" ConnectionString="<%$ ConnectionStrings:ConnStr %>"
                                                    SelectCommand="SELECT ROW_NUMBER() OVER(ORDER BY CSRID) AS Row , [CSRID] As Code ,MacName,  [CDName] , [EserialNo] , [SWO] , [CallStatus]  From vwCallServiceReport where CallStatus <> 'Close'  Order by Code"
                                                    FilterExpression="EserialNo like '%{0}%' or CDName like '%{1}%' or MacName like '%{2}%' ">
                                                    <FilterParameters>
