<%@ page language="C#" autoeventwireup="true" inherits="Warranty, App_Web_lzdpsiox" %>
    ...
    <div class="page">
        ...
        <div class="main">
            <fieldset id="fldStream" style="border: 1px solid #006600; width: 70%; margin-left: 170px;
                ...
                <asp:Panel ID="PnlHead" runat="server" Style="width: 85%; margin-left: 9px;">
                    <table align="center">
                        <tr>
                            <td>
                                <div align="center" style="padding: 5px;">
                                    <table cellpadding="0" cellspacing="5" style="border: solid 2px #b7ddf2; background: #ebf4fb;
                                        width: 85%; padding: 5px 5px 5px 10px">
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblWarranty" runat="server" Text="Warranty *" Width="120px"></asp:Label>
                                                <asp:TextBox ID="txtWarranty" runat="server" CssClass="validate[required]" Width="200px"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblPeriod" runat="server" Text="Period *" Width="120px"></asp:Label>
                                                <asp:DropDownList ID="ddlPeriod" runat="server" CssClass="validate[required]" Width="200px">
