<%@ page language="C#" autoeventwireup="true" inherits="Desgination, App_Web_lzdpsiox" %>
...
<body>
    ...
    <div class="page">
        ...
        <div class="main">
            <fieldset id="fldStream" style="border: 1px solid #006600; width: 53%; margin-left: 220px;
                margin-top: 30px;">
                <legend><span class="spanCss">Desgination</span></legend>
                <div>
                            ...
                            <td>
                                <div align="center" style="padding: 5px;">
                                    <table cellpadding="0" cellspacing="5" style="border: solid 2px #b7ddf2; background: #ebf4fb;
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblDesName" runat="server" Text="Desgination *" Width="120px"></asp:Label>
                                                <asp:TextBox ID="txtDesName" runat="server" CssClass="validate[required]" Width="330px"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
