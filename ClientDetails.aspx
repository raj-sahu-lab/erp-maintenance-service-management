<%@ page title=" Hospital | Client | Hospital Details | List of Hospital " language="C#" masterpagefile="~/AdminPage.master" autoeventwireup="true" inherits="ClientDetails, App_Web_tjb0csgq" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <fieldset id="fldStream" style="border: 1px solid #006600; width: 95.5%; margin: 16px;">
        <legend><span class="spanCss">Hospital List</span></legend>
        <div>
            <table style="border-bottom-style: dashed; border-bottom-width: 1px; border-top-style: dashed;
                ...
                <tr>
                    ...
                    <td class="TopRMsg">
                        <asp:Button ID="cmdNewItem" runat="server" OnClick="cmdNewItem_Click" Text="New Hospital"
                            CssClass="Button_submit" Height="25px" Width="100px" />
                    </td>
                </tr>
                <tr>
                    <td class="TopLMsg">
                        Filter By&nbsp; [Hospital , Mobile & City]
                    </td>
                    <td class="TopRMsg">
        ...
        <asp:Panel ID="PnlHead" runat="server" Style="width: 95%; margin-top: 13px; margin-left: 25px;
            margin-bottom: 15px">
            <table align="center">
                <tr>
                    <td>
                        <div align="center" style="padding: 4px;">
                            <table cellpadding="0" cellspacing="5" style="border: solid 2px #b7ddf2; background: #ebf4fb;">
                                <tr>
                                    <td>
                                        <asp:UpdatePanel ID="udpClientDetails" runat="server">
                                            <ContentTemplate>
                                                <asp:GridView ID="grdClientDetails" runat="server" CssClass="mGrid" AutoGenerateColumns=" False"
                                                    DataKeyNames="Code" DataSourceID="sDsClientDetails" EnableModelValidation="True"
                                                    PagerStyle-CssClass="pgr" OnRowCommand=" grdClientDetails_RowCommand" ShowFooter="True"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Hospital" SortExpression="CDName">
                                                        ...
                                                        <asp:BoundField DataField="ConPName" HeaderText="Contact Person" ItemStyle-Width="100px"
                                                            ItemStyle-HorizontalAlign="Left" />

                                                        <asp:TemplateField HeaderText="City" SortExpression="City">
                                                            <ItemStyle Width="70px" HorizontalAlign="Left" />
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblCity" Text='<%# HighlightText(Eval("City").ToString()) %>'
                                                                    runat="server" CssClass="TextField" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                ...
                                                <asp:SqlDataSource ID="sDsClientDetails" runat="server" ConnectionString="<%$ ConnectionStrings:ConnStr %>"
                                                    SelectCommand="SELECT ROW_NUMBER() OVER(ORDER BY CDID) AS Row , [CDID] As Code , [CDName] , [ConPName] , [City] , [Mobile] , [Website] From ClientDetails Order by Code"
                                                    FilterExpression="CDName like '%{0}%' or Mobile like '%{1}%' or City like '%{1}%' ">
                                                    <FilterParameters>
