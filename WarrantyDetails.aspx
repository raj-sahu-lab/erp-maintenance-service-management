<%@ page title="Warranty | WarrantyDetails" language="C#" masterpagefile="~/AdminPage.master" autoeventwireup="true" inherits="WarrantyDetails, App_Web_tjb0csgq" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <fieldset id="fldStream" style="border: 1px solid #006600; width: 75%; margin: 16px; margin-left: 110px; ">
        <legend><span class="spanCss">Warranty</span></legend>
        <div>
            <table style="border-bottom-style: dashed; border-bottom-width: 1px; border-top-style: dashed;
                ...
                <tr>
                    ...
                    <td class="TopRMsg">
                        <asp:Button ID="cmdNewItem" runat="server" OnClick="cmdNewItem_Click" Text="New Warranty"
                    ...
                    <td>
                        <div align="center" style="padding: 4px;">
                            <table cellpadding="0" cellspacing="5" style="border: solid 2px #b7ddf2; background: #ebf4fb;">
                                <tr>
                                    <td>
                                        <asp:UpdatePanel ID="udpWarranty" runat="server">
                                            <ContentTemplate>
                                                <asp:GridView ID="grdWarranty" runat="server" CssClass="mGrid" AutoGenerateColumns=" False"
                                                    DataKeyNames="Code" DataSourceID="sDsWarranty" EnableModelValidation="True" PagerStyle-CssClass="pgr"
                                                    OnRowCommand=" grdWarranty_RowCommand" ShowFooter="True" PageSize="30" AllowPaging="True"
                                                    AllowSorting="true">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Warranty" SortExpression="Warranty">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblWarranty" Text='<%# HighlightText(Eval("Warranty").ToString()) %>'
                                                                    runat="server" CssClass="TextField" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:BoundField DataField="Period" HeaderText="Period" ItemStyle-Width="30px" ItemStyle-HorizontalAlign="Left" />
                                                ...
                                                <asp:SqlDataSource ID="sDsWarranty" runat="server" ConnectionString="<%$ ConnectionStrings:ConnStr %>"
                                                    SelectCommand="SELECT [WID] As Code , [Warranty] , [Period] , [Status]  From Warranty Order by Code"
                                                    FilterExpression="Warranty like '%{0}%' ">
                                                    <FilterParameters>
                                                        <asp:ControlParameter Name="Warranty" ControlID="txtSearch" PropertyName="Text" />
                                                    </FilterParameters>
                                                </asp:SqlDataSource>
                                            </ContentTemplate>
                                            <Triggers>
