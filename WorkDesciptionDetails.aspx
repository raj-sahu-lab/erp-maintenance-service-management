<%@ page title="Work Desciption | Work Desciption Details" language="C#" masterpagefile="~/AdminPage.master" autoeventwireup="true" inherits="WorkDesciptionDetails, App_Web_tjb0csgq" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <fieldset id="fldStream" style="border: 1px solid #006600; width: 95.5%; margin: 16px;">
        <legend><span class="spanCss">Work Description</span></legend>
        <div>
            <table style="border-bottom-style: dashed; border-bottom-width: 1px; border-top-style: dashed;
                ...
                <tr>
                    ...
                    <td class="TopRMsg">
                        <asp:Button ID="cmdNewItem" runat="server" OnClick="cmdNewItem_Click" Text="New Work Description"
                            CssClass="Button_submit" Height="25px" Width="150px" />
                    </td>
                </tr>
                <tr>
                    <td class="TopLMsg">
        ...
        <asp:Panel ID="PnlHead" runat="server" Style="width: 55%; margin-top: 13px; margin-left: 200px;
            margin-bottom: 15px">
            <table align="center">
                <tr>
                    <td>
                        <div align="center" style="padding: 4px;">
                            <table cellpadding="0" cellspacing="5" style="border: solid 2px #b7ddf2; background: #ebf4fb;">
                                <tr>
                                    <td>
                                        <asp:UpdatePanel ID="udpWorkDescription" runat="server">
                                            <ContentTemplate>
                                                <asp:GridView ID="grdWorkDescription" runat="server" CssClass="mGrid" AutoGenerateColumns=" False"
                                                    DataKeyNames="Code" DataSourceID="sDsWorkDescription" EnableModelValidation="True"
                                                    PagerStyle-CssClass="pgr" OnRowCommand=" grdWorkDescription_RowCommand" ShowFooter="True"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Work Description" >
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblWDes" Text='<%# HighlightText(Eval("WDes").ToString()) %>' runat="server"
                                                                    CssClass="TextField" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                ...
                                                <asp:SqlDataSource ID="sDsWorkDescription" runat="server" ConnectionString="<%$ ConnectionStrings:ConnStr %>"
                                                    SelectCommand="SELECT [WDID] As Code , [WDes]  From WorkDescription Order by Code"
                                                    FilterExpression="WDes like '%{0}%' ">
                                                    <FilterParameters>
                                                        <asp:ControlParameter Name="WDes" ControlID="txtSearch" PropertyName="Text" />
                                                    </FilterParameters>
                                                </asp:SqlDataSource>
                                            </ContentTemplate>
                                            <Triggers>
